...
class Post(models.Model):
    post_category = models.ForeignKey(Category, on_delete=models.CASCADE, related_name='cat')
...
class ReviewSchool(models.Model):
    review_post = models.ForeignKey(Post, on_delete=models.CASCADE, related_name='review_school')
...
class ReviewOffice(models.Model):
    review_post = models.ForeignKey(Post, on_delete=models.CASCADE, related_name='review_office')
    review = models.TextField()
...
class ReviewKindergarten(models.Model):
    review_post = models.ForeignKey(Post, on_delete=models.CASCADE, related_name='review_cat_kindergarten')
    review = models.TextField()
    purity = models.IntegerField(
        validators=[MinValueValidator(1),
                    MaxValueValidator(10)],
